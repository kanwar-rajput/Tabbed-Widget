...
class MyNotebook(Frame):
    ...
    def error(self,method=None,error_no=None):
        ...
        print("Error , bad index : {}".format(method))
    ...
    def configtabs(self,*args,**kwargs):
        """ This method is used to config tabs of notebook. """
        for btn in self.btns:
            btn.config(*args,**kwargs)
...
if __name__ =='__main__':
    ...
    Button(root,text='L',command=lambda : nb.tab_positions('left')).pack(side='left')
    Button(root,text='R',command=lambda : nb.tab_positions('right')).pack(side='left')
    Button(root,text='T',command=lambda : nb.tab_positions('top')).pack(side='left')
    Button(root,text='B',command=lambda : nb.tab_positions('bottom')).pack(side='left')

    Button(root,text='Change Style',command = lambda :nb.style(bd=1,font=("Segoe Print",10),bg='red',activebackground='red',
            fg='white',activeforeground='white',tabbg='orange',focusbg='yellow',fieldbackground='red')).pack(side='left' , padx = 5)
    Button(root,text='Remove Style',command = lambda : nb.style(bd=0,font=("Helvetica",11),bg='#097FC8',activebackground='#097FC8',
            fg='white',activeforeground='white',tabbg='#0866A1',focusbg='#109DF4',fieldbackground='#097FC8')).pack(side='left' , padx = 5)
